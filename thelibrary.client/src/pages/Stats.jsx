...
const TABS = ['Overview', 'Coverage', 'Charts']
        ...
        <section>
            ...
            {tab === 'Coverage' && (
                <>
                    {stats.authorCoverage.length > 0 ? (
                        ...
                        <p className="subtle">No starred authors yet — star some authors to see coverage here.</p>
                    )}
                </>
            )}
            ...
            {tab === 'Charts' && (
                <>
                                ...
                                {stats.readByYear.map(({ year, count }) => {
                                    ...
                                    return (
                                        <div key={year} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.2rem' }}>
                                            ...
                                            <div style={{
                                                width: '2rem', height: `${h}%`, minHeight: '4px',
                    ...
                    {!stats.readByYear.length && !stats.formatBreakdown?.length && !stats.acquisitionByMonth?.length && (
                        <p className="subtle">No chart data available yet.</p>
                    )}
                </>
            )}
        </section>
