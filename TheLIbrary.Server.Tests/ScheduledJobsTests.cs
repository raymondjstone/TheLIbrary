...
public class ScheduledJobsTests
{
    ...
    public async Task Every_Scheduled_Entry_Point_Returns_When_Its_Schedule_Is_Disabled()
    {
        ...
        try
        {
            ...
            var jobs = new ScheduledJobs(
                ...
                null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, schedules, new FakeHostLifetime(),
    ...
    public async Task RunWithPolling_Returns_When_Schedule_Is_Disabled_And_Not_Manual()
    {
        ...
        var jobs = new ScheduledJobs(null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, lifetime, NullLogger<ScheduledJobs>.Instance);
        var ran = false;
