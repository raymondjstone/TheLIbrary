...
public class SchedulesController : ControllerBase
{
    ...
    private static bool JobIdMatchesMethod(string jobId, string methodName)
    {
        ...
        return jobId switch
        {
            ...
            ScheduleJobIds.IndexFullText => methodName == "RunIndexFullText",
            ScheduleJobIds.PruneAuthors => methodName == "RunPruneAuthors",
            ScheduleJobIds.DuplicateAutoArchive => methodName == "RunDuplicateAutoArchive",
            ScheduleJobIds.SeriesWatch => methodName == "RunSeriesWatch",
            ScheduleJobIds.AutoReplaceDamaged => methodName == "RunAutoReplaceDamaged",
            ScheduleJobIds.ResolveWorks => methodName == "RunResolveWorks",
            ScheduleJobIds.LlmIdentify => methodName == "RunLlmIdentify",
            ScheduleJobIds.LlmTitleMatch => methodName == "RunLlmTitleMatch",
            ScheduleJobIds.MarkOtherEditions => methodName == "RunMarkOtherEditions",
            ScheduleJobIds.MarkEditionsRead => methodName == "RunMarkEditionsRead",
            ScheduleJobIds.StarSeriesCoAuthors => methodName == "RunStarSeriesCoAuthors",
            ScheduleJobIds.ResolveIsbns => methodName == "RunResolveIsbns",
            ScheduleJobIds.RetryIsbnMisses => methodName == "RunRetryIsbnMisses",
            ScheduleJobIds.VerifyArchiveDuplicates => methodName == "RunVerifyArchiveDuplicates",
            ScheduleJobIds.ReviewUnapplicableScans => methodName == "RunReviewUnapplicableScans",
            _ => false,
        };
    }
}
