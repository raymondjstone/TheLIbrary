...
public sealed class ScheduleService
{
    ...
    public string TriggerNow(string jobId)
    {
        return jobId switch
        {
            ...
            ScheduleJobIds.LlmIdentify => BackgroundJob.Enqueue<ScheduledJobs>(j => j.RunLlmIdentify(true)),
            ScheduleJobIds.LlmTitleMatch => BackgroundJob.Enqueue<ScheduledJobs>(j => j.RunLlmTitleMatch(true)),
        ...
        try
        {
            switch (jobId)
            {
                ...
                case ScheduleJobIds.ResolveWorks:
                    ...
                    break;
                case ScheduleJobIds.LlmIdentify:
                    _recurring.AddOrUpdate<ScheduledJobs>(jobId, j => j.RunLlmIdentify(), entry.Cron);
                    break;
                case ScheduleJobIds.LlmTitleMatch:
                    _recurring.AddOrUpdate<ScheduledJobs>(jobId, j => j.RunLlmTitleMatch(), entry.Cron);
                    break;
                ...
                case ScheduleJobIds.PruneAuthors:
                    ...
                    break;
                case ScheduleJobIds.MarkOtherEditions:
                    _recurring.AddOrUpdate<ScheduledJobs>(jobId, j => j.RunMarkOtherEditions(), entry.Cron);
                    break;
                case ScheduleJobIds.MarkEditionsRead:
                    _recurring.AddOrUpdate<ScheduledJobs>(jobId, j => j.RunMarkEditionsRead(), entry.Cron);
                    break;
